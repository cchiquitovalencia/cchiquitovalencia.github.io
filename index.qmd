...
about: 
    ...
    links: 
        ...
        - text: X (Twitter)
          icon: twitter
          href: https://x.com/cchiquitov
---

# Crossing the path to Data Science

#### **Technical Skills**: [R](https://www.r-project.org/), [Quarto](https://quarto.org/), [Amazon Web Services](https://aws.amazon.com/), Vehicle Routing Problem, [Power BI](https://app.powerbi.com/), Excel, Maintenance Scheduling, Data Analysis, Mixed Integer Linear Programming, Machine Learning, [Shopify Web Design](https://www.shopify.com/co).

## Education

-   [AWS Cloud Solutions Architect](https://coursera.org/share/c957552fd68212ed4462e8a7f9faf96c) (December 2024)

-   [Data Science: Foundations using R Specialization](https://www.coursera.org/account/accomplishments/specialization/Z25X8FDPEMY3?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=s12n) (April 2022)
