...
-   Se puede lograr una distribución "*uniforme*" del tiempo de operación de cada vehiculo. Piensa en esto: el periodo #1 cuenta con $90 + 90 = 180$ horas de operación, pero en el siguiente periodo ninguno de los 2 vehículos se encuentra planeado para operar. En algunos días se puede
...
-   Cuánto es la duración de cada mantenimiento?

-   Qué pasa si la demanda de tiempo de operación es diferente para cada uno de los periodos en el horizonte de tiempo planeado?
